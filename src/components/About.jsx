    ...
    <div className="py-24 px-20 bg-gray-50 max-[375px]:py-16 max-[375px]:px-4 dark:bg-[#111827]">
      ...
      <div className="flex justify-between // max-[375px]:flex-col ">
        <div className="max-[375px]:flex max-[375px]:flex-col max-[375px]:items-center">
          ...
          <img
            className="w-[400px] h-[460px] relative left-4 border-solid dark:border-[#030712] border-white border-[7px] shadow-[-30px_35px_0px_0px_rgba(238,238,238)] dark:shadow-[-30px_28px_0px_0px_rgba(55,65,81)] // max-[375px]:w-[260px] max-[375px]:h-[350px] max-[375px]:shadow-[0px_0px_0px_0px_rgba(0,0,0)] max-[375px]:dark:shadow-[0px_0px_0px_0px_rgba(0,0,0)] max-[375px]:absolute max-[375px]:left-[57px] max-[375px]:top-[1019px]"
