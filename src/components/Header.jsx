...
export const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center px-20 py-4 dark:bg-[#030712] // max-[375px]:w-[375px] max-[375px]:h-[68px] max-[375px]:p-4">
      <div className=" text-3xl || max-[375px]:text-3xl max-[375px]:font-bold flex  gap-[209px]">
        &#60;SS /&#62;
        <svg
      ...
      <div className="flex items-center max-[376px]:hidden">
        <div className="flex gap-6 text-base mr-12 text-gray-600 font-medium dark:text-[#D1D5DB]">
          <p>About</p>
          <p>Work</p>
          <p>Testimonials</p>
          <p>Contact</p>
        ...
        <button className=" text-gray-50 w-[136px] h-9 rounded-xl bg-gray-900 dark:bg-white dark:text-[#111827]">
          Download CV
        </button>
      </div>
    </div>
